 ...
 */
declare function seedFromMnemonic(mnemonic: string): Uint8Array<ArrayBufferLike>;
/**
 ...
 */
declare function mnemonicToMasterDerivationKey(mn: string): Uint8Array<ArrayBufferLike>;
/**
