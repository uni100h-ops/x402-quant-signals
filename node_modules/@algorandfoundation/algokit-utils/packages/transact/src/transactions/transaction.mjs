...
var Transaction = class {
	...
	*/
	txId() {
		...
		return base32.encode(rawTxId).slice(0, 52);
	}
};
...
function computeGroup(transactions) {
	...
	return hash(concatArrays(new TextEncoder().encode("TG"), encodeMsgpack({ txlist: txHashes })));
}
