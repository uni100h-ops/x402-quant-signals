 ...
 */
export function crypto_sign_keypair(seed) {
 ...
 */
export function crypto_core_ed25519_add(pointA, pointB) {
    try {
...
export function crypto_core_ed25519_scalar_add(scalarA, scalarB) {
    ...
    if (scalarA.length !== crypto_scalarmult_ed25519_SCALARBYTES ||
        ...
        throw new Error(`scalars must be ${crypto_scalarmult_ed25519_SCALARBYTES} bytes`);
    }
 ...
 */
export function crypto_scalarmult(privateKey, publicKey) {
 ...
 */
export function crypto_sign_ed25519_pk_to_curve25519(edPubKey) {
    return ed25519.utils.toMontgomery(edPubKey);
}
/**
 * Convert Ed25519 secret key to X25519 secret key
 */
export function crypto_sign_ed25519_sk_to_curve25519(edSecretKey) {
 ...
 */
export function crypto_hash_sha512(message) {
 ...
 */
export function crypto_generichash(outputLength, message, key = null) {
    // Input validation
    if (outputLength < crypto_generichash_BYTES_MIN ||
        outputLength > crypto_generichash_BYTES_MAX) {
        throw new Error(`output length must be between ${crypto_generichash_BYTES_MIN} and ${crypto_generichash_BYTES_MAX} bytes`);
    }
    if (key) {
 ...
 */
export function crypto_kx_client_session_keys(clientPub, clientPriv, serverPub) {
 ...
 */
export function crypto_kx_server_session_keys(serverPub, serverPriv, clientPub) {
    // Step 1: Perform X25519 ECDH to get shared secret
    // Calling crypto_scalarmult rather than x25519.getSharedSecret to match facade function naming
 ...
 */
export function crypto_secretbox_easy(message, nonce, key) {
 ...
 */
export function crypto_secretbox_open_easy(ciphertext, nonce, key) {
    try {
...
//# sourceMappingURL=sumo.facade.js.map